...
console.log(`Grazing Line y=10 vs Disk B (y=0, r=10): ${intersectsDisk({ x: 0, y: 10 }, { x: 40, y: 10 }, diskB)}`);
console.log(`Overlap Line y=9.99 vs Disk B (y=0, r=10): ${intersectsDisk({ x: 0, y: 9.99 }, { x: 40, y: 9.99 }, diskB)}`);
console.log(`Micro-Overlap Line y=9.9999 vs Disk B (y=0, r=10): ${intersectsDisk({ x: 0, y: 9.9999 }, { x: 40, y: 9.9999 }, diskB)}`);
